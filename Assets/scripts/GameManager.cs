...
public class GameManager : MonoBehaviour
{
    ...
    private void Start()
    {
        // Adding the HandleReset function as a listener to our newly added OnResetPressed event
    ...
    private void SetPins()
    {
        ...
        // This is so that we don't create a new collection of standing pins on top of already fallen pins
        if (pinObjects)
        {
        ...
        // We add the IncrementScore function as a listener to the OnPinFall event of each new pin
